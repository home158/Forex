...
\begin{center}
\HRule \\[0.4cm]
{\Huge \bfseries Foreign Exchange Journal \\[0.5cm] \Large Notebook of Foreign Exchange}\\[0.4cm] % Degree
\HRule \\[1.5cm]
\end{center}
}
\author{\Huge Ivan Chu \\ \\ \LARGE home158@gmail.com \\[2cm]} % Your name and email address
\date{Beginning 21 May 2015} % Beginning date
\maketitle
